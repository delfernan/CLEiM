...
<html>
<head>
<title>FREEBASE SYMPTOM RESULTS</title>
...
if (term.equals("")||ipg<0){
  ...
  CallFBSym oFB=new CallFBSym(term);
  try {
  	oFB.setPage(ipg);
    oFB.queryFB();
...
<h1 align="center">FREEBASE SYMPTOM RESULTS</h1>
...
<thead> 
 <tr>
 <th>CONCEPT(SYMPTOM)</th>
 <th>IMAGE</th>
 <th>DESCRIPTION</th>
 <th>SYMPTOM OF</th>
 <th>SIDE EFFECT OF</th>
 </tr>
</thead> 
<tbody> 
<%
		...
		List<String> l3=oFB.getSympOfs();
		List<String> l4=oFB.getSideEfs();
